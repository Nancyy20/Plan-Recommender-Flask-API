...
def rbm(attractions_data, ratings_data, city, userid):
    ...
    # new return
    not_null_ratings = attractions_15_df.loc[attractions_15_df['rating'].notnull()]
    city_filtered_df = not_null_ratings[not_null_ratings['city'] == city.lower()]
    # print("Return of RBM function ")
    # print(city_filtered_df)
    # print("End of printing")
    return city_filtered_df
